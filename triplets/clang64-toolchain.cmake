# MSYS2 CLANG64 toolchain for vcpkg chainloading.
#
# This intentionally mirrors vcpkg's built-in MinGW toolchain shape, but uses
# the CLANG64 compiler driver names so vcpkg-built packages stay in the same
# Clang + libc++ + UCRT ABI family as the project's mingw-clang-* presets.
if(NOT _MCPP_CLANG64_TOOLCHAIN)
    set(_MCPP_CLANG64_TOOLCHAIN 1)
    ...
    if(VCPKG_TARGET_ARCHITECTURE STREQUAL "x64")
        ...
        message(FATAL_ERROR
            "clang64-toolchain.cmake currently supports only x64, got "
            "VCPKG_TARGET_ARCHITECTURE='${VCPKG_TARGET_ARCHITECTURE}'")
    endif()

    foreach(lang C CXX)
        set(CMAKE_${lang}_COMPILER_TARGET
            "${CMAKE_SYSTEM_PROCESSOR}-w64-windows-gnu"
            CACHE STRING "")
    endforeach()

    find_program(CMAKE_C_COMPILER
        "${CMAKE_SYSTEM_PROCESSOR}-w64-mingw32-clang")
