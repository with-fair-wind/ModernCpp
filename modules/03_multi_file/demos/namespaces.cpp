...
int main() {
    ...
    std::cout << "math_lib::add(2, 3) = " << math_lib::add(2, 3) << " (默认 v2)\n";
    std::cout << "math_lib::multiply(2, 3) = " << math_lib::multiply(2, 3) << " (v2 独有)\n";
    std::cout << "math_lib::v1::add(2, 3) = " << math_lib::v1::add(2, 3) << " (显式旧版本)\n";
    std::cout << "math_lib::v2::add(2, 3) = " << math_lib::v2::add(2, 3) << " (显式新版本)\n";
